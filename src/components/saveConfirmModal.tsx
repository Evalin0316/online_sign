...
interface SaveConfirmProps {
  ...
  setIsSaveFile: (save: boolean) => void
}

const SaveConfirm = ({ setShowSaveConfirm, setIsSaveFile }: SaveConfirmProps) => {
  return (
    <div className="w-full left-0 top-0 fixed h-screen" style={{ 'background':'rgba(140, 93, 25, 0.3)' }}>
      <div className="confirm__container">
        ...
        <div className="flex flex-col confirm__container__group">
          <div className="confirm__container__group__button font-bold" onClick={() => setIsSaveFile(true)}>確定</div>
